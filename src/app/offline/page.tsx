  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-slate-50 px-4 py-10">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-600">The connection is unavailable. Construction Manager does not queue financial or inventory changes offline, so no critical record has been posted.</p>
